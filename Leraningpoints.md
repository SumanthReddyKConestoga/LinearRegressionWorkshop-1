...
### How I derived MinC and MaxC (choose one and document)
...
* Optionally store alert/error events to a DB table, or log to CSV for submission.
...
* Derived **MinC/MaxC from residual distributions** (quantiles or SPC limits), not guesswork.
